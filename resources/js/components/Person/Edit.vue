<template>
    <div class="w-25" v-if="person">
        ...
        <div >
            <input :disabled="!isDisabled" @click.prevent="$store.dispatch('update', {id: person.id, name: person.name, age:person.age, job:person.job})"  type="submut" value="Update" class="btn btn-primary">
        </div>
    </div>
